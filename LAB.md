...
- **B. `H-B1-1c`** — дешёвый known-answer тест №2 с в 5 раз более острым допуском; закрывает Step 4a на
  правильном потолке. ~1 сессия.
- **C. Автоматизация болей пилота** — только пункты (1)–(3) выше, не «лаборатория-как-ОС».
