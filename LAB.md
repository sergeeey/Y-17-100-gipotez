...
**Следующие кандидаты:**
- **D.** merge/push ветки D: `y17/pilot-pains` (72 теста зелёные, не запушено — решение владельца)
- **E.** Реальный расчёт H-B3-1: скачать EDI/NTL-LTER данные, реализовать Takens embedding + Ripser, сравнить lead time — крупный шаг, соразмерный пилоту H-B1-1a
- **F.** Phase 2 H-B3-1 (≥3 коллапса) — гейтится на исходе E
