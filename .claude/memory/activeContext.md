...
**Priority 2 пользователя (fresh confirmatory experiment, κ(V)/ω(A) как comparators) теперь
разблокирован, назван в decision.md, НЕ запущен автоматически.** **[WS: H-B2-1s] CLOSED.**
Ждёт подтверждения пользователя на Priority 2.
