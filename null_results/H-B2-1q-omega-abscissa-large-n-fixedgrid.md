# null_results/H-B2-1q-omega-abscissa-large-n-fixedgrid.md

**Copied verbatim from** `experiments/20260907-chernoff-neuralode-nd-numerical-abscissa-fixedgrid/decision.md`
(2026-09-07). See that file for the live version; this copy is the permanent record per FL
null_results protocol.
